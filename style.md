...
- Hold lock order epoch → allocator: code under `EpochState::mutex_` may re-enter `DeviceAllocator`; keep allocator code self-contained so it resolves device state entirely within the allocator.
